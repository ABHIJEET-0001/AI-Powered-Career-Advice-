...
function saveProfile() {
  ...
  currentUser.profile = {
    ...
    interests,
    codingProfiles: {
      github: document.getElementById("github-profile") ? document.getElementById("github-profile").value.trim() : "",
      leetcode: document.getElementById("leetcode-profile") ? document.getElementById("leetcode-profile").value.trim() : "",
      codeforces: document.getElementById("codeforces-profile") ? document.getElementById("codeforces-profile").value.trim() : ""
    }
  };
  const users = JSON.parse(localStorage.getItem("users") || "[]");
